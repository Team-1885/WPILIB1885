...
/**
 * Class responsible for managing all of the {@link CSVWriter}s. Logging events are sent to this class in the form of ImmutablePair of the String to log, which is expected to be CSV format, and the {@link RobotCodex} in the CSVLogger#logFromCodexToCSVLog(ImmutablePair)
 *
 * This class will run a timer thread that will periodically look for log events and will pass them onto the specific {@link CSVWriter} for the event's {@link RobotCodex}
 */
