...
public final class GetLocalIP {
   ...
   * 
   * @return
   *         An optional that will contain the IP if it was sucessfully retrieved.
   ...
   * keep reading from the passed in reader until all IPs are found. Then the
   * method
   * will return the first match. If there are no IPs or any other errors, this
   * method
