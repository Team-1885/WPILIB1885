...
public class PIDController implements Sendable {
  ...
  public double calculate(double input, double absoluteTime) {
    ...
    if ((mError * mPIDControl.get(EPIDController.P_GAIN) < mMaximumOutput)
        && (mError * mPIDControl.get(EPIDController.P_GAIN) > mMinimumOutput)) {
    ...
    mResult = (mPIDControl.get(EPIDController.P_GAIN) * proportionalError)
        + (mPIDControl.get(EPIDController.I_GAIN) * mTotalError)
        + (mPIDControl.get(EPIDController.D_GAIN) * (mError - mPrevError) / mDt)
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.addDoubleProperty("p", () -> mPIDControl.get(EPIDController.P_GAIN),
        (pP) -> mPIDControl.set(EPIDController.P_GAIN, pP));
    builder.addDoubleProperty("i", () -> mPIDControl.get(EPIDController.I_GAIN),
        (pI) -> mPIDControl.set(EPIDController.I_GAIN, pI));
    builder.addDoubleProperty("d", () -> mPIDControl.get(EPIDController.D_GAIN),
        (pD) -> mPIDControl.set(EPIDController.D_GAIN, pD));
