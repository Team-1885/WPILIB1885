...
/**
 * @author jmshapiro
 *         RangeScale will scale an input value in range a to range b or the
 *         reverse.
 */
public class RangeScale {
  ...
  public double scaleAtoB(double aInput) {
    return (aInput - this.rangeAMin) / (this.rangeAMax - this.rangeAMin) * (this.rangeBMax - this.rangeBMin)
        + this.rangeBMin;
  }

  public double scaleBtoA(double bInput) {
    return (bInput - this.rangeBMin) / (this.rangeBMax - this.rangeBMin) * (this.rangeAMax - this.rangeAMin)
        + this.rangeAMin;
  }
}