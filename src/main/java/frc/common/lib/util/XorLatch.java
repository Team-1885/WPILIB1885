...
public class XorLatch {
   ...
   * 1.) Flag has not been tripped since reset (pExit.get() && pEntry.get()) ==
   * false)
   * 2.) Flag has been tripped but not untripped since reset (pExit.get ^
   * pEntry.get() == true)
   * 3.) Flag has been tripped and untripped since reset (pEntry.get() &&
   * pExit.get() == true)
   * 
