...
public class CameraConfig {
  ...
  public static final CameraConfig LIMELIGHT_V2_LOW_RES = new CameraConfig(49.7, 59.6, 90.0, 1000.0 / 90.0, 320, 240),
      LIMELIGHT_V2_HI_RES = new CameraConfig(49.7, 59.6, 90.0, 1000.0 / 90.0, 0d, 0d);

  public final double hResolution,
      hFOV_deg,
      vResolution,
      vFOV_deg,
      framerate,
  ...
  public CameraConfig(double _vFOV_deg, double _hFOV_deg, double _framerate, double _latency, double _hResolution,
      double _vResolution) {
    vFOV_deg = _vFOV_deg;
    hFOV_deg = _hFOV_deg;
   ...
   * 
   * @param pElevationAngle_deg elevation angle from the floor in degrees, range =
   *                            [-90,90]. 0 = Camera lens is
   *                            perfectly level. 90 = Camera lens faces the
   *                            ceiling; -90 = Camera lens faces the floor. In
   *                            some configurations this changes often (such as
   *                            when it's on a servo).
