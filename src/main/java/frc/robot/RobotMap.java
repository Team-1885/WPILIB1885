...
@SuppressWarnings({"PMD.CommentSize", "PMD.LongVariable"}) public final class RobotMap {
  /**
   * {@link https://docs.wpilib.org/en/stable/docs/software/hardware-apis/motors/wpi-drive-classes.html%3Adifferential-drive-robots}
   */
  public static final class WestCoastDriveConstants {
