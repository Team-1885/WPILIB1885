...
public class Robot extends TimedRobot {
  ...
  /**
   * ⚙️ This function is run when the robot is first started up and should be used for any initialization code.
   */
  @Override
   ...
   * ⚙️ Use this for items like diagnostics that you want ran during disabled, autonomous, teleoperated and test.
  ...
  public void robotPeriodic() {
    ...
    // 🏗️ This must be called from the robot's periodic block in order for anything in the Command-based framework to work.
  ...
  /** 🏗️ This function is called periodically during operator control. */
  @Override
